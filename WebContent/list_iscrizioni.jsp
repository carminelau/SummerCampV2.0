<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,main.model.entity.Centro,main.model.entity.Iscrizione, main.model.entity.Bambino, main.model.entity.Settimana, main.control.gestioneIscrizione.VisualizzaIscrizioniControl"
	pageEncoding="UTF-8"%>
